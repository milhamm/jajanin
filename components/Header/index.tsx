...
const Header = () => {
  return (
    <div className='flex justify-between items-center gap-5 pt-5'>
      <button>
        <HiOutlineMenu className='text-red-500 text-[2rem] laptop:hidden' />
      </button>
      <h1 className='font-["Mazzard"] text-[2em] text-red-500 mobile:hidden'>
        Jajanin
      </h1>
      ...
      <div className='flex gap-8 text-gray-300 mobile:hidden'>
